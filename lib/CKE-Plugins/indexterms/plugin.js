...
(function(){
    ...
    CKEDITOR.plugins.add('indexterms', {
        ...
        "init" : function(editor){
            CKEDITOR.dialog.add("indextermDialog", this.path + "dialogs/indextermsDialog.js");
            editor.addCommand("indextermDialog", new CKEDITOR.dialogCommand("indextermDialog"));
            ...
            if(editor.contextMenu){
                editor.addMenuGroup("indextermGroup");
                editor.addMenuItem('indexItem', {
                    "label": "Edit Index Term",
                    "command": "indextermDialog",
                    "group": "indextermGroup"
                });

                editor.contextMenu.addListener(function(element){
                    var parent = element.getAscendant("span");

                    if(parent && parent.getName() === "span" && parent.getAttribute("class") === "cke-indexterm"){
                        return {"indexItem": CKEDITOR.TRISTATE_OFF };
                    }
                });
            }
        }
