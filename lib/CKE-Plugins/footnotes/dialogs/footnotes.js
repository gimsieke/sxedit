...
(function(){
    ...
    footnoteStore.prototype.renderFootnotesBox = function(){
        ...
        if(fnDiv !== undefined && fnDiv !== null){
            ...
            for(elem in this.footnotes){
                var fnEditorInstance = CKEDITOR.inline(elem, {
                    "on":{
                    ...
                    "toolbar": [
                        ...
                        {
                            "name": "objects", 
                            "items": ["CreatePlaceholder", "Image", "Flash", "Table", "Iframe"]
                        }
                    ]
                });
                console.log(fnEditorInstance.config.plugins);
            }
        }
    };
...
CKEDITOR.dialog.add("footnotesDialog", function(editor){
    return {
        ...
        "onOk": function(){
            ...
            editor.config["autosave_SaveKey"] = 'autosave_' + editor.id + "_" + window.location;
